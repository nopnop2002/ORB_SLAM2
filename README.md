...
Original use the new thread and chrono functionalities of **C++11**. However, Pangolin uses the **C++14** language specification. 
...
Clone the repository that supports Ubuntu 18.04:
```
...
**Example**: Download a sequence from [here](https://vision.in.tum.de/data/datasets/rgbd-dataset/download).   
```
mkdir dataset
cd dataset
